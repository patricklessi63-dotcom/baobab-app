-- ============================================================================
-- SCRIPT CONSOLIDÉ — tous les correctifs SQL en attente (45 fichiers)
...
--    supabase-report-rate-limit-fix.sql sont des sections SUPERSEDED dont le
--    DDL D'ORIGINE EST TOUJOURS PRÉSENT (contrairement à ce qui était affirmé
--    dans les versions antérieures de cet en-tête) : concaténées APRÈS les
--    versions plus récentes des mêmes objets, elles écrasaient en dernier
--    les gardes banni/onboarding/suppression sur likes/follows/favorites/
--    event_invitations, le garde-fou anti-bot global sur "reports", et la
--    garde d'auth de create_event(). La DERNIÈRE section du script
--    (supabase-combined-supersede-order-regression-fix.sql) rejoue les
--    versions autoritaires de ces objets tout à la fin — c'est elle qui
--    fixe l'état final. Ne pas la déplacer ni la retirer.
...
-- ============================================================================
-- SOURCE : supabase-post-likes-comments-block-fix.sql
-- ============================================================================
-- ============================================================================
...
-- ============================================================================
-- SOURCE : supabase-content-account-state-block-guards-remaining-fix.sql
-- ============================================================================
-- ============================================================================
...
-- réécrit après sa création initiale) : community_posts (état de compte
-- absent, pas de cible) ; community_post_likes et community_comments (état
-- de compte absent, blocage absent contre l'auteur du post via post_id) ;
-- event_comments (état de compte absent, blocage absent contre
-- events.created_by) ; story_reactions et story_views (état de compte
-- absent, blocage déjà couvert indirectement — voir NOTE ci-dessous) ;
-- message_reactions (état de compte absent, blocage absent contre l'autre
-- participant du match_key).
--
...
-- ==========================================================================
-- SOURCE : supabase-combined-supersede-order-regression-fix.sql
-- ==========================================================================
-- ============================================================================
