...
import SearchResultsDropdown from "./social/SearchResultsDropdown";
          ...
          <div className="flex items-center gap-2 shrink-0 relative">
            ...
            {notificationsOpen && (
              <NotificationsDropdown
                ...
                notifPillRefs={notifPillRefs}
                incomingFavoritesCount={incomingFavoritesCount}
                visibleCommunityNotifications={visibleCommunityNotifications}
                onNotifTouchStart={onNotifTouchStart}
                onNotifTouchEnd={onNotifTouchEnd}
                ...
                setViewedProfileId={setViewedProfileId}
                openChatWithProfileId={openChatWithProfileId}
                setOpenCommunityId={setOpenCommunityId}
