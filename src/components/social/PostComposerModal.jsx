              ...
              <>
                <div className="flex items-center justify-between gap-3 p-5 md:p-6 pb-3 shrink-0" style={{ borderBottom: "1px solid rgba(var(--bb-ink-rgb),0.06)" }}>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button onClick={publish} disabled={!canPublish} className="rounded-xl px-4 py-2.5 text-sm text-white font-bold disabled:opacity-40" style={{ background: navy }}>Publier</button>
                ...
                <div className="overflow-y-auto p-5 md:p-6 pt-3">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      <textarea value={draft} onChange={(e) => setDraft(e.target.value)} className="w-full min-h-32 rounded-2xl p-4 outline-none resize-none" style={{ background: bg }} placeholder="Écris ton message..." />
