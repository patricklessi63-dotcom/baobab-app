                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        <textarea
                          ...
                          className="w-full min-h-32 rounded-2xl p-4 outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--bb-leaf)] resize-none disabled:opacity-70"
                          style={{ background: bg }}
