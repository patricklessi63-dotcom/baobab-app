      ...
      <div ref={panelRef} tabIndex={-1} className={`${card} w-full max-w-md rounded-t-[30px] md:rounded-[30px] p-6 max-h-[85vh] overflow-y-auto`} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center gap-2 mt-1.5">
          <input
            ...
            className="w-full rounded-xl p-3 text-sm outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--bb-leaf)]"
            style={{ background: bg }}
        ...
        {error && <p role="alert" className="text-xs mt-3" style={{ color: coralText }}>{error}</p>}
