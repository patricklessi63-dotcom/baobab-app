    ...
    <div className="flex flex-col gap-3">
      <div className="flex items-center gap-2">
        <input
          ...
          className="flex-1 text-sm rounded-xl px-3.5 py-2.5 outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--bb-leaf)]"
          style={{ background: bg }}
        />
        {hasActiveFilters && (
          <button
